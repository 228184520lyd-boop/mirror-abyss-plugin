/** Mirror Abyss mobile-safe floating loader 2.0.0-lite.ui.98-semantic-lifecycle-manual-merge. */
...
function load() {
  mount();
  return loaded ??= import('./app.js?ui=98-semantic-lifecycle-manual-merge').catch(error => {
    loaded = undefined;
    showError(error);
    throw error;
  });
