import { alignPatchRowsToCanonicalSnapshot, canonicalObjectTitle, canonicalizeObjectIdentities } from './domain-object-identity.js';
import { deriveIncrementalSettlementDirectives } from './domain-incremental-settlement.js';
import { applyEntryLifecycleDirectives, finalizeSettlingEntries, } from './domain-entry-lifecycle.js';
import { ensureCurrentSceneEntry, enforceObjectViewAllocation, filterPassiveObservers, preserveObjectBaseLayers, preservePersistentCharacters, removeFocusCharacterDuplicates, } from './domain-snapshot.js';
import { enforceSpacetimeSingleton } from './domain-special-table-rules.js';
import { dedupeStrongStateRows } from './domain-state-text.js';
