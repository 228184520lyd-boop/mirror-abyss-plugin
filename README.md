...
版本：`1.2.0-rc.53`　流水线：`ma-pipeline-53`
...
固定文本重构见 `RC52_FIXED_TEXT_PROTOCOL_REPORT.md`，对象唯一性与世界书修复见 `RC53_UNIQUE_OBJECT_LOREBOOK_REPORT.md`，验收结果见 `VALIDATION.md`。旧版本报告保存在源码包的 `docs/history/`，不随安装包发布。
